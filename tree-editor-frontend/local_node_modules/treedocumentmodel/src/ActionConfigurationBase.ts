...
export class ActionConfigurationBase extends BasicEObjectImpl
  ...
  get availableActions(): OrderedSet<Action> {
    if (this._availableActions === null) {
      this._availableActions = new OrderedSet<Action>(
        this,
        TreedocumentmodelPackageLiterals.ACTION_CONFIGURATION__AVAILABLE_ACTIONS,
  ...
  get defaultActionbarActions(): OrderedSet<Action> {
    if (this._defaultActionbarActions === null) {
      this._defaultActionbarActions = new OrderedSet<Action>(
        this,
        TreedocumentmodelPackageLiterals.ACTION_CONFIGURATION__DEFAULT_ACTIONBAR_ACTIONS,
        BasicEObjectImpl.EOPPOSITE_FEATURE_BASE -
          TreedocumentmodelPackageLiterals.ACTION_CONFIGURATION__DEFAULT_ACTIONBAR_ACTIONS
      );
    }
  ...
  get nodeActions(): EMap<string, string> {
    if (this._nodeActions === null) {
      this._nodeActions = new EcoreEMap<string, string>(
        ActionIdToNodeTypeMapBase.eStaticClass,
        ActionIdToNodeTypeMapBase,
        this,
        TreedocumentmodelPackageLiterals.ACTION_CONFIGURATION__NODE_ACTIONS
      );
    }
