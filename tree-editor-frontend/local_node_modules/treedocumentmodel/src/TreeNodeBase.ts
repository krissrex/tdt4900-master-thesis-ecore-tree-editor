...
export class TreeNodeBase extends BasicEObjectImpl implements TreeNode {
  private _id: string = "";
  get id(): string {
    return this._id;
  }
  ...
  get children(): OrderedSet<TreeNode> {
    if (this._children === null) {
      this._children = new OrderedSet<TreeNode>(
        this,
        TreedocumentmodelPackageLiterals.TREE_NODE__CHILDREN,
        TreedocumentmodelPackageLiterals.TREE_NODE__PARENT
      );
    }
  ...
  set parent(value: TreeNode) {
    if (value != (this.eInternalContainer() as TreeNode)) {
      ...
      if ((this.eInternalContainer() as TreeNode) != null) {
        msgs = (this.eInternalContainer() as TreeNode).eInverseRemove(
          this,
          TreedocumentmodelPackageLiterals.TREE_NODE__CHILDREN,
          /*TreeNode*/ null,
          msgs
  ...
  set iconOverride(value: NodeIcon) {
    if (value != this.iconOverride) {
      ...
      if (this.iconOverride != null) {
        msgs = this.iconOverride.eInverseRemove(
          this,
          BasicEObjectImpl.EOPPOSITE_FEATURE_BASE -
            TreedocumentmodelPackageLiterals.TREE_NODE__ICON_OVERRIDE,
          /*null*/ null,
          msgs
        );
      }
  ...
  public basicSetIconOverride(
    newobj: NodeIcon,
    msgs: NotificationChain
  ): NotificationChain {
    let oldobj = this.iconOverride;
    this.iconOverride = newobj;
